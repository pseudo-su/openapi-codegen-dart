library simple_petstore_jaguar_sdk.api;

import 'package:http/http.dart' as http;
import 'package:jaguar_serializer/jaguar_serializer.dart';
import 'package:jaguar_retrofit/jaguar_retrofit.dart';
import 'package:simple_petstore_jaguar_sdk/auth/api_key_auth.dart';
import 'package:simple_petstore_jaguar_sdk/auth/basic_auth.dart';
import 'package:simple_petstore_jaguar_sdk/auth/oauth.dart';
import 'package:jaguar_mimetype/jaguar_mimetype.dart';

import 'package:simple_petstore_jaguar_sdk/api/pets_api.dart';
...
class SimplePetstoreJaguarSdk {
    ...
    */
    SimplePetstoreJaguarSdk({List<Interceptor> interceptors, bool overrideInterceptors = false, String baseUrl, this.timeout = const Duration(minutes: 2)}) {
