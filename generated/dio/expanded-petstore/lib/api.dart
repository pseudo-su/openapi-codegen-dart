library expanded_petstore_dio_sdk.api;

import 'package:dio/dio.dart';
import 'package:built_value/serializer.dart';
import 'package:expanded_petstore_dio_sdk/serializers.dart';
import 'package:expanded_petstore_dio_sdk/auth/api_key_auth.dart';
import 'package:expanded_petstore_dio_sdk/auth/basic_auth.dart';
import 'package:expanded_petstore_dio_sdk/auth/oauth.dart';
import 'package:expanded_petstore_dio_sdk/api/pets_api.dart';


final _defaultInterceptors = [OAuthInterceptor(), BasicAuthInterceptor(), ApiKeyAuthInterceptor()];

class ExpandedPetstoreDioSdk {

    Dio dio;
    Serializers serializers;
    String basePath = "http://petstore.swagger.io/v1";

    ExpandedPetstoreDioSdk({this.dio, Serializers serializers, String basePathOverride, List<Interceptor> interceptors}) {
        if (dio == null) {
